...
/**
 * All default constant values
 */
public class Commons {
    public static final int WINDOW_WIDTH = 700;
    public static final int WINDOW_HEIGHT = 900;
    public static final int START_POS_X = WINDOW_WIDTH / 2 - 50;
    public static final int START_POS_Y = WINDOW_HEIGHT;
    public static final int DELAY = 10;

    public static final int TIE_SPEED = 2;
